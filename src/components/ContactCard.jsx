      ...
      <div className="flex justify-center gap-3 mb-4">
        {mapLinks?.neshan && (
          <a href={mapLinks.neshan} target="_blank" rel="noopener noreferrer"
            ...
            <img src="/images/navIcons/neshan.png" alt="نشان" className="w-5 h-5" />
          </a>
        )}
        {mapLinks?.balad && (
          <a href={mapLinks.balad} target="_blank" rel="noopener noreferrer"
             className="bg-gray-100 p-2 rounded-full hover:bg-gray-200 transition">
            <img src="/images/navIcons/balad.png" alt="بلد" className="w-5 h-5" />
          </a>
        )}
        {mapLinks?.waze && (
          <a href={mapLinks.waze} target="_blank" rel="noopener noreferrer"
             className="bg-gray-100 p-2 rounded-full hover:bg-gray-200 transition">
            <img src="/images/navIcons/waze.png" alt="ویز" className="w-5 h-5" />
          </a>
        )}
        {mapLinks?.google && (
          <a href={mapLinks.google} target="_blank" rel="noopener noreferrer"
             className="bg-gray-100 p-2 rounded-full hover:bg-gray-200 transition">
            <img src="/images/navIcons/googlemaps.png" alt="گوگل مپ" className="w-5 h-5" />
          </a>
        )}
      </div>
